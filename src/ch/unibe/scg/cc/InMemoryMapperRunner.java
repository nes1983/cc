...
class InMemoryMapperRunner implements MapperRunner {
	@Override
	public <IN, OUT> void run(Provider<? extends Mapper<IN, OUT>> mapperProvider, CellSource<IN> src,
			CellSink<OUT> sink,	Codec<IN> srcCodec, Codec<OUT> sinkCodec) throws IOException {
