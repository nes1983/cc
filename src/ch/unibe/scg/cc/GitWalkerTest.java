...
public final class GitWalkerTest {
	...
	public void testPopulate() throws IOException {
		...
		Iterable<Iterable<Cell<CodeFile>>> filePartitions = i.getInstance(Key.get(new TypeLiteral<CellSource<CodeFile>>() {})).partitions();
		...
		Iterable<Iterable<Cell<Function>>> functionPartitions = i.getInstance(Key.get(new TypeLiteral<CellSource<Function>>() {})).partitions();
		...
		Iterable<Iterable<Cell<Snippet>>> snippetPartitions = i.getInstance(Key.get(new TypeLiteral<CellSource<Snippet>>() {})).partitions();
