...
public class FrontendTest {
	...
	public void testType2() {
		...
		Frontend frontend = new Frontend(null, null, p1, p2, null, null, null,
				null, null, null);
		String s = frontend
	...
	public Frontend testNormalize() {
		Frontend frontend = new Frontend(null, null, phaseFrontend,
				phaseFrontend, null, null, null, null, null, null);
	...
	public void testTokenizer() {
		Frontend frontend = new Frontend(null, null, phaseFrontend, null, null,
				null, tokenizer, null, null, null);
		CodeFile cf = mock(CodeFile.class);
		frontend.registerWithBuilder(new StringBuilder(
				"\npublic    static void doIt(char[] arg) {\n"),
				"MickeyPaint.java", cf);
		verify(tokenizer).tokenize(
				eq("\npublic    static void doIt(char[] arg) {\n"),
				eq("MickeyPaint.java"));
	}
